 ...
 */ 
const Toggle = ({ color, disabled, onChange, status = false, }) => {
  ...
  return (
    <ToggleContainer className={bemDestruct(className, disabled)} onClick={disabled ? null : handleClick} disabled={disabled}>
      <ToggleCircleIcon
        props={{
          position: 'relative',
          right: '2px',
